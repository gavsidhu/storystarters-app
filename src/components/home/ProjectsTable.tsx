...
const ProjectsTable = ({ projects }: Props) => {
  ...
  return (
    <>
      ...
      <div className='py-6'>
        <div className='cardShadow overflow-hidden bg-white sm:rounded-2xl'>
          <ul role='list' className='divide-y divide-gray-200'>
            {projects.map((project) => (
              <li key={project.id} id={project.id}>
                <Link
                  href={`/projects/${project.id}`}
                  className='group block hover:bg-primary-500 hover:text-white'
                ...
                >
                  <div className='flex items-center justify-between px-4 py-4 sm:px-6'>
                    ...
                    <div className='mt-2 sm:flex sm:justify-end'>
                      <div className='mt-2 flex items-center text-sm text-gray-500 group-hover:text-white sm:mt-0'>
                        <p>
